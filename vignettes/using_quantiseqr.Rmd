...
## Example 1: Metastatic melanoma patients (Racle et al 2017)
...
```{r ex1-tiplot, fig.height=4, fig.width=8}
quantiplot(ti_racle)
```
...
## Example 2: PBMCs, GSE107572 et al analysis, example 1

Here we show how to use `quantiseqr` to deconvolute blood-derived immune-cell mixtures, for which also matching flow cytometry data are available. 

This is also presented as an example in [@Plattner2020], please refer to this publication for additional details.
...
## Example 4: Running on simulated data for validation
