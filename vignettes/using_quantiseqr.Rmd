...
tpmdata <-read.table("GSE107572/GSE107572_tpm_PBMC_RNAseq.txt.gz", header = TRUE)
...
```{r}
load("/Users/fede/Dropbox/quanTIseq_batch2/GSE20300_mixture.RData")
arraydata <- mix.mat
dim(arraydata)
...
load("/Users/fede/Dropbox/quanTIseq_batch2/GSE20300_gtruth.RData")

head(RefData)

plot(as.data.frame(RefData)$Neutrophils, ti_quant_blood_marray$Neutrophils)
plot(as.data.frame(RefData)$Monocytes, ti_quant_blood_marray$Monocytes)
plot(as.data.frame(RefData)$Lymphocytes, 
