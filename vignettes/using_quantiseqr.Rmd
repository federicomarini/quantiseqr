...
- B cells
- M1 Macrophages (classically activated, pro-inflammatory type)
- M2 Macrophages (alternatively activated, with anti-inflammatory properties)
- Monocytes 
- Neutrophils
- NK cells (natural killer cells)
- CD4+ T cells (non-regulatory "helper" T cells)
...
```{r ex2-comparison, fig.width=9, fig.height=9, fig.cap="Scatterplot of quanTIseq cell fractions for the PBMCs dataset, plotted against the fractions estimated from flow cytometry. Each subplot display a specific cell type, and all cells are summarized in the lower right corner. The dashed grey line indicates the diagonal, corresponding to the identity line, while the black solid line is the linear model fit. The text annotation reports the r correlation coefficient, its significance, and the root mean squared error."}
GEOid <- "GSE107572"
gds <- getGEO(GEOid)
GEOinfo <- pData(gds[[1]])
FACSdata <- data.frame(
